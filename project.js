...
window.onload = () => {
  ...
  let shapes2 = [
    ...
    line([10, 40], [130, 40], {stroke: colors.dim}),
    line([130, 40], [200, 40], {stroke: colors.sentence}),
    line([40, 50], [200, 50], {stroke: colors.sentence}),
    line([30, 60], [170, 60], {stroke: colors.sentence}),
    line([60, 60], [100, 60], {stroke: colors.bright, strokeWidth: 2}),
    line([170, 60], [200, 60], {stroke: colors.dim}),
    line([100, 70], [200, 70], {stroke: colors.dim}),
    line([40, 90], [200, 90], {stroke: colors.dim}),
    line([50, 100], [200, 100], {stroke: colors.dim}),
    line([20, 110], [200, 110], {stroke: colors.dim}),
    line([150, 120], [200, 120], {stroke: colors.dim}),
  ];
  shapes1.forEach(s =>
  {
